...
# Parse the DOS data
re_energies, dos, species_resolved, title, elements, concentrations, n_species = sprkkr_dos_plotting.sprkkr_dos_read('dos/_Al_DOS_DOS.dos', l_max=2, spin_channels=2)
