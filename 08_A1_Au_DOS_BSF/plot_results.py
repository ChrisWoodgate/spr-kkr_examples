...
# Parse the BSF data
bsfdata = sprkkr_bsf_plotting.parse_bsfdata('blochsf/_Au_BSFEK_BLOCHSF.bsf')

l_max = 2

# Parse the DOS data
re_energies, dos, species_resolved, lm_resolved, title, elements, concentrations, n_species = sprkkr_dos_plotting.sprkkr_dos_read('dos/_Au_DOS_DOS.dos', l_max=l_max, spin_channels=2)
...
ax.set_title(r'Au DOS: $l$-resolved')

plt.tight_layout()
plt.savefig('./Au_l-resolved.pdf')
plt.close()
